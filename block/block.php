...
function dappier_render_askai_block( $attributes, $content, $block ) {
	try {
		...
		// If previewing in the block editor, render a preview.
		if ( $editor ) {
			$html = dappier_render_askai_block_preview();
		} else {
...
/**
 * Render the Dappier AskAI block preview.
 *
 * @since TBD
 *
 * @return string Returns the block preview HTML.
 */
function dappier_render_askai_block_preview() {
	ob_start();
	?>
	<div class="dappier-askai-preview" style="
		text-align: center;
		padding: 32px 24px;
		background-color: rgba(228, 218, 248, 0.1);
		border: 2px dashed rgba(131, 83, 226, 0.3);
		border-radius: 4px;
		transition: all 0.2s ease-in-out;
	">
		<svg style="max-width:200px;height:auto;" data-bbox="-0.001 0 407.001 159.755" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 407 160" height="160" width="407" data-type="ugc">
			<g>
